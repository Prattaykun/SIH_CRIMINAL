...
def main():
    ...
    import sys
    label_path = sys.argv[1] if len(sys.argv) > 1 else os.path.join("data", "case_type_cyber", "ml", "entity_context_review_completed_v6.csv")
    feat_path = sys.argv[2] if len(sys.argv) > 2 else os.path.join("data", "case_type_cyber", "ml", "graph_features_rich_cleaned_v6.csv")
    ...
    out_model = os.path.join("models", "random_forest_context_proxy_v3.pkl")
    out_feat = os.path.join("models", "random_forest_context_proxy_v3_features.json")
    out_pred = os.path.join("data", "case_type_cyber", "ml", "context_proxy_predictions_v3.csv")
    out_metrics = os.path.join("data", "case_type_cyber", "ml", "random_forest_context_proxy_v3_metrics.json")
    out_limit = os.path.join("data", "case_type_cyber", "ml", "CONTEXT_PROXY_LIMITATIONS_v3.md")
