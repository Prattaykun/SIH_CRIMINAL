...
def main():
    ...
    edges_path = os.path.join("data", "case_type_cyber", "graphs", "ner_edges_cleaned.json")
    out_path = os.path.join("data", "case_type_cyber", "ml", "graph_features_rich_cleaned.csv")
