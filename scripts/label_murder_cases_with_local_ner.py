...
def main():
    in_path = os.path.join("data", "case_type_murder", "ner", "murder_cases_raw.jsonl")
    out_path = os.path.join("data", "case_type_murder", "ner", "murder_cases_labeled.jsonl")
    ...
    print(f"Loaded {len(records)} murder records. Labeling using {model_path}...")
