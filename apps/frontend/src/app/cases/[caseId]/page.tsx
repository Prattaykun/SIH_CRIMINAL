    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link 
            href={`/cases/${caseId}/evidence#upload`}
            className="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-md text-sm font-medium transition shadow-[0_0_15px_rgba(79,70,229,0.3)]"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <Link 
              href={`/cases/${caseId}/evidence#upload`}
              className="block p-4 rounded-lg border bg-blue-500/10 border-blue-500/30 hover:bg-blue-500/20 transition"
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded flex items-center justify-center bg-blue-500/20 text-blue-400">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg>
                  </div>
                  <div>
                    <h4 className="font-medium text-blue-400">Document Ingestion & Extraction</h4>
                    <p className="text-xs text-slate-400 mt-1">Upload PDFs, DOCX, or text files to run async NLP extraction</p>
                  </div>
                </div>
                <svg className="w-5 h-5 text-blue-500/50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" /></svg>
              </div>
            </Link>
